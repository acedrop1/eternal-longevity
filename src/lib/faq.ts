...
export const FAQS: FAQ[] = [
  ...
  // === Safety ===
  {
    ...
    a: "Some are (e.g., Tesamorelin, PT-141). Many are compounded under 503A authority for off-label or non-FDA-approved use. Compounded medications occupy a legitimate but distinct regulatory category. The specific status of each peptide is noted on its protocol page. This is not medical advice or a substitute for consulting your own healthcare provider.",
  },
  {
    category: 'Safety',
