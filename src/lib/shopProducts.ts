...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  },
  {
    ...
    swatch: 'linear-gradient(180deg, #1e4d4a 0%, #002C28 100%)',
    image: '/images/13.jpg',
  ...
  },
  {
    ...
    swatch: 'linear-gradient(180deg, #2a5048 0%, #002C28 100%)',
    image: '/images/14.jpg',
  ...
  },
  {
    ...
    swatch: 'linear-gradient(180deg, #2e5048 0%, #002C28 100%)',
    image: '/images/7.jpg',
  ...
  },
  {
    ...
    swatch: 'linear-gradient(180deg, #4a604e 0%, #002C28 100%)',
    image: '/images/8.jpg',
  ...
  // ============ METABOLIC ============
  {
    ...
    swatch: 'linear-gradient(180deg, #3e5a52 0%, #002C28 100%)',
    image: '/images/12.jpg',
  ...
  },
  {
    ...
    swatch: 'linear-gradient(180deg, #4e6258 0%, #002C28 100%)',
    image: '/images/5.jpg',
  ...
  // ============ COGNITIVE ============
  {
    ...
    swatch: 'linear-gradient(180deg, #2a4a48 0%, #002C28 100%)',
    image: '/images/6.jpg',
  ...
  },
  {
    ...
    cycleLength: '12-week cycle',
    pricing: { monthly: 140, quarterly: 380, annual: 1340 },
    swatch: 'linear-gradient(180deg, #2e4e4e 0%, #002C28 100%)',
    image: '/images/1.jpg',
  ...
  // ============ SEXUAL HEALTH ============
  {
    ...
    swatch: 'linear-gradient(180deg, #4a5042 0%, #002C28 100%)',
    image: '/images/8.jpg',
  ...
  // ============ LONGEVITY & SKIN ============
  {
    ...
    swatch: 'linear-gradient(180deg, #3a4e48 0%, #002C28 100%)',
    image: '/images/10.jpg',
